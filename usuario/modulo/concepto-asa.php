<?php
	...
	if($cantidadASAFAE>0){
		...
		if($totalGlobalASA>0){ $infoTotalGlobalASA='S/. '.moneda($totalGlobalASA); }else{ $infoTotalGlobalASA='<i class="fa fa-ellipsis-h"></i>'; }
		if($totalGlobalASA_JUS>0){ $infoTotalGlobalASA_JUS='- S/. '.moneda($totalGlobalASA_JUS); }else{ $infoTotalGlobalASA_JUS='<i class="fa fa-ellipsis-h"></i>'; }
		if($totalGlobalASA_PGD>0){ $infoTotalGlobalASA_PGD='- S/. '.moneda($totalGlobalASA_PGD); }else{ $infoTotalGlobalASA_PGD='<i class="fa fa-ellipsis-h"></i>'; }
		if($totalGlobalASA_DEU>0){ $infoTotalGlobalASA_DEU='S/. '.moneda($totalGlobalASA_DEU); }else{ $infoTotalGlobalASA_DEU='<i class="fa fa-ellipsis-h"></i>'; }
?>
	<div class="panel">
		...
		<div class="totalMonto">
			<div class="row">
				<div class="col-sm-3">
					<ul class="list-group">
						<li class="list-group-item"><span>TOTAL</span> <span class="pull-right text-danger textoNegrita"><?= $infoTotalGlobalASA ?></span></li>
					</ul>
				</div>
				<div class="col-sm-3">
					<ul class="list-group">
						<li class="list-group-item"><span>JUSTIFICADOS</span> <span class="pull-right text-danger textoNegrita"><?= $infoTotalGlobalASA_JUS ?></span></li>
					</ul>
				</div>
				<div class="col-sm-3">
					<ul class="list-group">
						<li class="list-group-item"><span>CAJA</span> <span class="pull-right text-danger textoNegrita"><?= $infoTotalGlobalASA_PGD ?></span></li>
					</ul>
				</div>
				<div class="col-sm-3">
					<ul class="list-group">
						<li class="list-group-item"><span>DEBEN</span> <span class="pull-right text-danger textoNegrita"><?= $infoTotalGlobalASA_DEU ?></span></li>
					</ul>
				</div>
			</div>
		</div>
