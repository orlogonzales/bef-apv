<?php if($totalFAE>0){ ?>
	...
	<div class="panel">
		<div class="panel-heading bg-slate-600"><h6 class="panel-title">INGRESOS A CAJA POR CONCEPTO DE FAENAS</h6></div>
		...
		<div class="panel-body">
			<div class="table-responsive">
				<table class="table tablaT table-bordered table-hover tabla-caja-ing">
					...
					<tbody>
						<?php
							$sql="SELECT fechaOperacion, tipoActividad, concepto, codigoSocio, codigoConcepto, tipoDocumento, nroDocumento, monto, detalleConcepto, codigoOperacion, fecha, hora, usuario FROM sm_mod_caja WHERE movimiento='ING' AND tipoActividad='FAE' AND (fechaOperacion BETWEEN '$consultaFechaIni' AND '$consultaFechaFin') $consultaUsuario ORDER BY id DESC";
