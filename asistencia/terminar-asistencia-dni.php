							...
							<div id="registro">
								<div class="col-lg-6 col-lg-offset-3">
									<div class="panel panel-body border-top-xlg border-top-warning-800 text-center">
										...
										<h5 style="margin-bottom: 10px; padding-bottom: 10px; border-bottom: 1px solid #CCC;"><a href="<?= $urlSistemaTerminarActividad ?>" class="btn btn-primary btn-md" style="font-size: 15px;">REGISTRAR CON <strong style="font-weight: bolder;">TARJETA</strong></a></h5>
											...
											$(document).ready(function(){
												...
												$("#DNISocio").on( "keypress", function(event) {
													if (event.which == 13 && !event.shiftKey) {
														...
														var operacion       = 'REGISTRA_SALIDA_DNI';
